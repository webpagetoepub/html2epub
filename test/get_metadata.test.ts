...
test('returns date from meta[name="article:published_time"]', () => {
  const doc = makeDoc(
    '<meta name="article:published_time" content="2022-03-10T10:00:00Z">',
  );
...
test('returns author from [itemprop="author"] meta[itemprop="name"]', () => {
  const doc = makeDoc(
    '<div itemprop="author"><meta itemprop="name" content="John Smith"></div>',
  );
...
test('returns publisher from [itemprop="publisher"] meta[itemprop="name"]', () => {
  const doc = makeDoc(
    '<div itemprop="publisher"><meta itemprop="name" content="The Times"></div>',
  );
